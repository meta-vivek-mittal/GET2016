...
Using the above Queue structure implement College counselling process. 

Create queue of all the candidates based on their respective ranks. Higher rank will be at the starting. 

Creating List of Colleges that will be available for admission. Take minimum 5 colleges as available, So each candidate will 
have option to select from 1 to 5 ranked colleges.
