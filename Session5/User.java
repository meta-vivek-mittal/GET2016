...
public class User extends Node {
	 ...
	 * @param name(String) denotes the name of organization
	 * @param type(String) denotes the name of profile
	 * @param contact(String) denotes the contact detail
	 * @param address(String) denotes the address
	 */
